...
class SparseMatrix():
    ...
    def create_from_coords(cls, coords_iterator, resolution, bcube):
        ...
        """
        """
        colors = [(221,221,221,1),(219,125,62,1),(179,80,188,1),
                  (107,138,201,4),(177,166,39,1),(65,174,56,1),
                  (208,132,153,1),(64,64,64,1),(154,161,161,1),
                  (46,110,137,4),(126,61,181,4),(46,56,141,4),
                  (79,50,31,1),(53,70,27,1),(150,52,48,1),(25,22,22,1)]
        ...
        colors = [(221,221,221,1),(219,125,62,1.2),(179,80,188,1.4),
                  ...
                  (79,50,31,1.1),(53,70,27,1.1),(150,52,48,1.1),(25,22,22,2)]
        """
        ...
        """
        """
        colors = [(221,221,221,1),(219,125,62,4),(179,80,188,4),
                  (107,138,201,4),(177,166,39,1),(65,174,56,4),
                  (208,132,153,4),(64,64,64,1.5),(154,161,161,0.7),
                  (46,110,137,4),(126,61,181,4),(46,56,141,4),
                  (79,50,31,4),(53,70,27,4),(150,52,48,4),(25,22,22,4)]
        """          
        scores = [];
